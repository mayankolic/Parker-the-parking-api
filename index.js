...
app.get('/:vehicleNumber', async(req, res) => {
  ...
  try {
    ...
    console.log((data));
    var currt = new Date();
    res.json({ ownerName: data.ownerName, vehicleType: data.vehicleType, vehicleNumber: data.vehicleNumber, EntryTime: data.createdAt, DispatchedTime: currt.toISOString() });
    // var vehicletobed
